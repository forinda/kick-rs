...
## [0.1.1](https://github.com/forinda/kick-rs/compare/kick-rs-cli-v0.1.0...kick-rs-cli-v0.1.1) - 2026-05-23
...
- *(cli)* cargo kick dev — watch the source tree and restart on save
