...
## [0.1.1](https://github.com/forinda/kick-rs/compare/kick-rs-http-v0.1.0...kick-rs-http-v0.1.1) - 2026-05-23

### Other

- release

## [0.1.0](https://github.com/forinda/kick-rs/compare/kick-rs-http-v0.1.0-alpha.4...kick-rs-http-v0.1.0) - 2026-05-23

### Other

- *(release)* graduate all crates from 0.1.0-alpha.X to 0.1.0

## [0.1.0-alpha.4](https://github.com/forinda/kick-rs/compare/kick-rs-http-v0.1.0-alpha.3...kick-rs-http-v0.1.0-alpha.4) - 2026-05-23
...
- *(http)* contributor pipeline bypass for framework-owned routes
